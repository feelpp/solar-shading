...
image::images/colorcompare.png[Barplot comparing execution time][600]
...
[.speedtest]
image::images/intel.png[Comparing Intel's flags][600]
...
[.speedtest]
image::images/AMDspeed.png[Barplot comparing execution time on an AMD system][600]
