...
int main(int argc, char *argv[]){
    ...
    Rand::Vmt19937_64 urng{ 42 }; // THIS is the fast generator (thrice as fast as P8_mt19937_64 for int generation)
    ...
    std::cout << flag << ",EigenRand_VMT," << meanEigenRandMicros << '\n';
    ...
    file << flag << ",EigenRand_VMT," << meanEigenRandMicros << '\n';
    file.close();
