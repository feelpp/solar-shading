        ...
        {            
            ...
            if (QMAKE_WITH_SPECX) {
                ...
                else if (M_mthreadtype == "markers")
                {
                    ...
                    //std::cout<<"M_Nrays="<<M_Nrays<<" NbTh="<<NbTh;
                    //int SizeBloc=M_Nrays/NbTh;
                    //int DiffBloc=M_Nrays-SizeBloc*NbTh;

                    //std::cout<<" NbBloc="<<SizeBloc<< " T="<<SizeBloc*NbTh<<" DiffBloc"<<DiffBloc<<"\n";
                    //getchar();
